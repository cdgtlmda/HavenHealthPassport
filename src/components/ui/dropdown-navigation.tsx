        ...
        {navItems.map((navItem) => (
          ...
          >
            {navItem.link ? (
              <Link
                to={navItem.link}
                className="text-sm py-1.5 px-3 flex cursor-pointer group transition-colors duration-300 items-center justify-center gap-1 text-muted-foreground hover:text-foreground relative whitespace-nowrap"
